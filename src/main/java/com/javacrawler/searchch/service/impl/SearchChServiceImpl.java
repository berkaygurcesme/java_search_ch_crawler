...
public class SearchChServiceImpl implements SearchChService {
  ...
  public long chServiceCrawler() {
    ...
    System.setProperty(
      ...
      "/Users/berkay/MyProjects/java/searchch/chromedriver"
    );
          ...
          if (inputArray.length == 4) {
            ...
            personEntity =
              new PersonEntity(
                ...
                Optional
                  .ofNullable(personList.get(a).getText().split("\\R")[1])
                  .orElseGet(() -> ""),
                Optional
                  .ofNullable(personList.get(a).getText().split("\\R")[2])
                  .orElseGet(() -> ""),
                "",
                cantonArray[a]
              );
